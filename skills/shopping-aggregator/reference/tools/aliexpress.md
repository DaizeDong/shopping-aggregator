...
3. Request **API permission** for the app. Affiliate review is usually **~2 business days** (open a support ticket if no email in 3–4 days).
...
- Listed/Choice prices have effectively **risen 20–40%** and customs clearance adds delivery delay.
