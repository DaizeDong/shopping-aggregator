...
## #5 — Seller tiers (L1–L5): WHO sold it
...
required on every L1–L4 retailer live-fetch unit — but a **missing seller_name degrades the tier to
...
> **Run B war-story:** a Best Buy "$4,899" listing was actually a 3.74★ Marketplace 3P — caught
...
> **Run B war-story:** the "$5,140" figure was an E3 SERP snippet; the real E1 white-OC PDP was
> $4,299.99 — neither the same number nor the same SKU.
...
> **Run B war-story:** codex ~$3.6–4.0k vs Newegg E1 PDP $4,299.99 vs a $5,140 E3 snippet were
